...
export interface Fixture {
  ...
  poolPointsOverride?: number; // overrides the phase's default pool for this one match (e.g. 3rd-place game)
}
...
export const KNOCKOUT_FIXTURES: Fixture[] = [
  ...
  { matchNumber: 73, phase: 'round32' as Phase, team1: 'RSA', team2: 'CAN', venue: 'SoFi Stadium',           city: 'Los Angeles',  date: '2026-06-28T19:00:00Z', canDraw: false, aiPrediction: 'CAN' },
  { matchNumber: 74, phase: 'round32' as Phase, team1: 'GER', team2: 'PAR', venue: 'Gillette Stadium',       city: 'Boston',       date: '2026-06-29T20:30:00Z', canDraw: false, aiPrediction: 'GER' },
  { matchNumber: 75, phase: 'round32' as Phase, team1: 'NED', team2: 'MAR', venue: 'Estadio BBVA',           city: 'Guadalajara',  date: '2026-06-30T01:00:00Z', canDraw: false, aiPrediction: 'NED' },
  { matchNumber: 76, phase: 'round32' as Phase, team1: 'BRA', team2: 'JPN', venue: 'NRG Stadium',            city: 'Houston',      date: '2026-06-29T17:00:00Z', canDraw: false, aiPrediction: 'BRA' },
  { matchNumber: 77, phase: 'round32' as Phase, team1: 'FRA', team2: 'SWE', venue: 'MetLife Stadium',        city: 'New York/NJ',  date: '2026-06-30T21:00:00Z', canDraw: false, aiPrediction: 'FRA' },
  { matchNumber: 78, phase: 'round32' as Phase, team1: 'CIV', team2: 'NOR', venue: 'AT&T Stadium',           city: 'Dallas',       date: '2026-06-30T17:00:00Z', canDraw: false, aiPrediction: 'NOR' },
  { matchNumber: 79, phase: 'round32' as Phase, team1: 'MEX', team2: 'ECU', venue: 'Estadio Azteca',         city: 'Mexico City',  date: '2026-07-01T01:00:00Z', canDraw: false, aiPrediction: 'MEX' },
  { matchNumber: 80, phase: 'round32' as Phase, team1: 'ENG', team2: 'COD', venue: 'Mercedes-Benz Stadium',  city: 'Atlanta',      date: '2026-07-01T16:00:00Z', canDraw: false, aiPrediction: 'ENG' },
  { matchNumber: 81, phase: 'round32' as Phase, team1: 'USA', team2: 'BIH', venue: "Levi's Stadium",         city: 'San Francisco',date: '2026-07-02T00:00:00Z', canDraw: false, aiPrediction: 'USA' },
  { matchNumber: 82, phase: 'round32' as Phase, team1: 'BEL', team2: 'SEN', venue: 'Lumen Field',            city: 'Seattle',      date: '2026-07-01T20:00:00Z', canDraw: false, aiPrediction: 'BEL' },
  { matchNumber: 83, phase: 'round32' as Phase, team1: 'POR', team2: 'CRO', venue: 'BMO Field',              city: 'Toronto',      date: '2026-07-02T23:00:00Z', canDraw: false, aiPrediction: 'POR' },
  { matchNumber: 84, phase: 'round32' as Phase, team1: 'ESP', team2: 'AUT', venue: 'SoFi Stadium',           city: 'Los Angeles',  date: '2026-07-02T19:00:00Z', canDraw: false, aiPrediction: 'ESP' },
  { matchNumber: 85, phase: 'round32' as Phase, team1: 'SUI', team2: 'ALG', venue: 'BC Place',               city: 'Vancouver',    date: '2026-07-03T03:00:00Z', canDraw: false, aiPrediction: 'SUI' },
  { matchNumber: 86, phase: 'round32' as Phase, team1: 'ARG', team2: 'CPV', venue: 'Hard Rock Stadium',      city: 'Miami',        date: '2026-07-03T22:00:00Z', canDraw: false, aiPrediction: 'ARG' },
  { matchNumber: 87, phase: 'round32' as Phase, team1: 'COL', team2: 'GHA', venue: 'Arrowhead Stadium',      city: 'Kansas City',  date: '2026-07-04T01:30:00Z', canDraw: false, aiPrediction: 'COL' },
  ...
  { matchNumber: 95, phase: 'round16' as Phase, team1: 'ARG', team2: 'EGY', venue: 'Mercedes-Benz Stadium',  city: 'Atlanta',      date: '2026-07-07T16:00:00Z', canDraw: false },
  ...
  // Third Place
  { matchNumber: 103, phase: 'final', team1: 'FRA', team2: 'ENG', venue: 'Hard Rock Stadium', city: 'Miami', date: '2026-07-18T21:00:00Z', canDraw: false, poolPointsOverride: 350 },
