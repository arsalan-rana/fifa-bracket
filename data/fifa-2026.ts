...
export const GROUP_FIXTURES: Fixture[] = [
  ...
  { matchNumber: 2,  phase: 'group', group: 'A', team1: 'KOR', team2: 'CZE', venue: 'Estadio Akron', city: 'Guadalajara', date: '2026-06-12T22:00:00Z', canDraw: true, aiPrediction: 'KOR' },
  { matchNumber: 3,  phase: 'group', group: 'A', team1: 'MEX', team2: 'KOR', venue: 'Estadio Akron', city: 'Guadalajara', date: '2026-06-19T22:00:00Z', canDraw: true, aiPrediction: 'MEX' },
  { matchNumber: 4,  phase: 'group', group: 'A', team1: 'CZE', team2: 'RSA', venue: 'Mercedes-Benz Stadium', city: 'Atlanta', date: '2026-06-18T22:00:00Z', canDraw: true, aiPrediction: 'CZE' },
  { matchNumber: 5,  phase: 'group', group: 'A', team1: 'RSA', team2: 'KOR', venue: 'Estadio Akron', city: 'Guadalajara', date: '2026-06-25T22:00:00Z', canDraw: true, aiPrediction: 'KOR' },
  { matchNumber: 6,  phase: 'group', group: 'A', team1: 'CZE', team2: 'MEX', venue: 'Estadio Azteca', city: 'Mexico City', date: '2026-06-25T22:00:00Z', canDraw: true, aiPrediction: 'MEX' },

  // ── GROUP B ──
  { matchNumber: 7,  phase: 'group', group: 'B', team1: 'CAN', team2: 'BIH', venue: 'BMO Field', city: 'Toronto', date: '2026-06-12T22:00:00Z', canDraw: true, aiPrediction: 'CAN' },
  { matchNumber: 8,  phase: 'group', group: 'B', team1: 'QAT', team2: 'SUI', venue: "Levi's Stadium", city: 'San Francisco', date: '2026-06-13T22:00:00Z', canDraw: true, aiPrediction: 'SUI' },
  { matchNumber: 9,  phase: 'group', group: 'B', team1: 'SUI', team2: 'BIH', venue: 'SoFi Stadium', city: 'Los Angeles', date: '2026-06-18T22:00:00Z', canDraw: true, aiPrediction: 'SUI' },
  ...
  { matchNumber: 11, phase: 'group', group: 'B', team1: 'SUI', team2: 'CAN', venue: 'BC Place', city: 'Vancouver', date: '2026-06-24T22:00:00Z', canDraw: true, aiPrediction: 'SUI' },
  { matchNumber: 12, phase: 'group', group: 'B', team1: 'BIH', team2: 'QAT', venue: 'Lumen Field', city: 'Seattle', date: '2026-06-24T22:00:00Z', canDraw: true, aiPrediction: 'BIH' },
  ...
  { matchNumber: 14, phase: 'group', group: 'C', team1: 'HAI', team2: 'SCO', venue: 'Gillette Stadium', city: 'Boston', date: '2026-06-14T22:00:00Z', canDraw: true, aiPrediction: 'SCO' },
  ...
  { matchNumber: 16, phase: 'group', group: 'C', team1: 'BRA', team2: 'HAI', venue: 'Lincoln Financial Field', city: 'Philadelphia', date: '2026-06-20T22:00:00Z', canDraw: true, aiPrediction: 'BRA' },
  ...
  { matchNumber: 20, phase: 'group', group: 'D', team1: 'AUS', team2: 'TUR', venue: 'BC Place', city: 'Vancouver', date: '2026-06-14T01:00:00Z', canDraw: true, aiPrediction: 'TUR' },
  { matchNumber: 21, phase: 'group', group: 'D', team1: 'USA', team2: 'AUS', venue: 'Lumen Field', city: 'Seattle', date: '2026-06-19T22:00:00Z', canDraw: true, aiPrediction: 'USA' },
  { matchNumber: 22, phase: 'group', group: 'D', team1: 'TUR', team2: 'PAR', venue: "Levi's Stadium", city: 'San Francisco', date: '2026-06-20T22:00:00Z', canDraw: true, aiPrediction: 'TUR' },
  { matchNumber: 23, phase: 'group', group: 'D', team1: 'TUR', team2: 'USA', venue: 'SoFi Stadium', city: 'Los Angeles', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'USA' },
  { matchNumber: 24, phase: 'group', group: 'D', team1: 'PAR', team2: 'AUS', venue: "Levi's Stadium", city: 'San Francisco', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'PAR' },

  // ── GROUP E ──
  { matchNumber: 25, phase: 'group', group: 'E', team1: 'GER', team2: 'CUR', venue: 'NRG Stadium', city: 'Houston', date: '2026-06-14T22:00:00Z', canDraw: true, aiPrediction: 'GER' },
  { matchNumber: 26, phase: 'group', group: 'E', team1: 'CIV', team2: 'ECU', venue: 'Lincoln Financial Field', city: 'Philadelphia', date: '2026-06-15T22:00:00Z', canDraw: true, aiPrediction: 'CIV' },
  { matchNumber: 27, phase: 'group', group: 'E', team1: 'GER', team2: 'CIV', venue: 'BMO Field', city: 'Toronto', date: '2026-06-20T22:00:00Z', canDraw: true, aiPrediction: 'GER' },
  { matchNumber: 28, phase: 'group', group: 'E', team1: 'ECU', team2: 'CUR', venue: 'Arrowhead Stadium', city: 'Kansas City', date: '2026-06-21T22:00:00Z', canDraw: true, aiPrediction: 'ECU' },
  { matchNumber: 29, phase: 'group', group: 'E', team1: 'CUR', team2: 'CIV', venue: 'Lincoln Financial Field', city: 'Philadelphia', date: '2026-06-25T22:00:00Z', canDraw: true, aiPrediction: 'CIV' },
  { matchNumber: 30, phase: 'group', group: 'E', team1: 'ECU', team2: 'GER', venue: 'MetLife Stadium', city: 'New York/NJ', date: '2026-06-25T22:00:00Z', canDraw: true, aiPrediction: 'GER' },

  // ── GROUP F ──
  { matchNumber: 31, phase: 'group', group: 'F', team1: 'NED', team2: 'JPN', venue: 'AT&T Stadium', city: 'Dallas', date: '2026-06-14T22:00:00Z', canDraw: true, aiPrediction: 'NED' },
  { matchNumber: 32, phase: 'group', group: 'F', team1: 'SWE', team2: 'TUN', venue: 'Estadio BBVA', city: 'Guadalajara', date: '2026-06-15T22:00:00Z', canDraw: true, aiPrediction: 'SWE' },
  { matchNumber: 33, phase: 'group', group: 'F', team1: 'NED', team2: 'SWE', venue: 'NRG Stadium', city: 'Houston', date: '2026-06-20T22:00:00Z', canDraw: true, aiPrediction: 'NED' },
  { matchNumber: 34, phase: 'group', group: 'F', team1: 'TUN', team2: 'JPN', venue: 'Estadio BBVA', city: 'Guadalajara', date: '2026-06-21T22:00:00Z', canDraw: true, aiPrediction: 'JPN' },
  { matchNumber: 35, phase: 'group', group: 'F', team1: 'TUN', team2: 'NED', venue: 'Arrowhead Stadium', city: 'Kansas City', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'NED' },
  { matchNumber: 36, phase: 'group', group: 'F', team1: 'JPN', team2: 'SWE', venue: 'AT&T Stadium', city: 'Dallas', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'JPN' },
  ...
  { matchNumber: 38, phase: 'group', group: 'G', team1: 'IRN', team2: 'NZL', venue: 'SoFi Stadium', city: 'Los Angeles', date: '2026-06-16T22:00:00Z', canDraw: true, aiPrediction: 'IRN' },
  { matchNumber: 39, phase: 'group', group: 'G', team1: 'BEL', team2: 'IRN', venue: 'SoFi Stadium', city: 'Los Angeles', date: '2026-06-21T22:00:00Z', canDraw: true, aiPrediction: 'BEL' },
  { matchNumber: 40, phase: 'group', group: 'G', team1: 'NZL', team2: 'EGY', venue: 'BC Place', city: 'Vancouver', date: '2026-06-22T22:00:00Z', canDraw: true, aiPrediction: 'EGY' },
  { matchNumber: 41, phase: 'group', group: 'G', team1: 'NZL', team2: 'BEL', venue: 'BC Place', city: 'Vancouver', date: '2026-06-27T22:00:00Z', canDraw: true, aiPrediction: 'BEL' },
  { matchNumber: 42, phase: 'group', group: 'G', team1: 'EGY', team2: 'IRN', venue: 'Lumen Field', city: 'Seattle', date: '2026-06-27T22:00:00Z', canDraw: true, aiPrediction: 'EGY' },

  // ── GROUP H ──
  { matchNumber: 43, phase: 'group', group: 'H', team1: 'ESP', team2: 'CPV', venue: 'Mercedes-Benz Stadium', city: 'Atlanta', date: '2026-06-15T22:00:00Z', canDraw: true, aiPrediction: 'ESP' },
  ...
  { matchNumber: 45, phase: 'group', group: 'H', team1: 'ESP', team2: 'SAU', venue: 'Mercedes-Benz Stadium', city: 'Atlanta', date: '2026-06-21T22:00:00Z', canDraw: true, aiPrediction: 'ESP' },
  ...
  { matchNumber: 47, phase: 'group', group: 'H', team1: 'CPV', team2: 'SAU', venue: 'NRG Stadium', city: 'Houston', date: '2026-06-27T22:00:00Z', canDraw: true, aiPrediction: 'SAU' },
  { matchNumber: 48, phase: 'group', group: 'H', team1: 'URU', team2: 'ESP', venue: 'Estadio Akron', city: 'Guadalajara', date: '2026-06-27T22:00:00Z', canDraw: true, aiPrediction: 'ESP' },

  // ── GROUP I ──
  { matchNumber: 49, phase: 'group', group: 'I', team1: 'FRA', team2: 'SEN', venue: 'MetLife Stadium', city: 'New York/NJ', date: '2026-06-16T22:00:00Z', canDraw: true, aiPrediction: 'FRA' },
  ...
  { matchNumber: 51, phase: 'group', group: 'I', team1: 'FRA', team2: 'IRQ', venue: 'Lincoln Financial Field', city: 'Philadelphia', date: '2026-06-22T22:00:00Z', canDraw: true, aiPrediction: 'FRA' },
  { matchNumber: 52, phase: 'group', group: 'I', team1: 'NOR', team2: 'SEN', venue: 'BMO Field', city: 'Toronto', date: '2026-06-23T22:00:00Z', canDraw: true, aiPrediction: 'NOR' },
  { matchNumber: 53, phase: 'group', group: 'I', team1: 'NOR', team2: 'FRA', venue: 'Gillette Stadium', city: 'Boston', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'FRA' },
  { matchNumber: 54, phase: 'group', group: 'I', team1: 'SEN', team2: 'IRQ', venue: 'BMO Field', city: 'Toronto', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'SEN' },

  // ── GROUP J ──
  { matchNumber: 55, phase: 'group', group: 'J', team1: 'ARG', team2: 'ALG', venue: 'Arrowhead Stadium', city: 'Kansas City', date: '2026-06-17T22:00:00Z', canDraw: true, aiPrediction: 'ARG' },
  { matchNumber: 56, phase: 'group', group: 'J', team1: 'AUT', team2: 'JOR', venue: "Levi's Stadium", city: 'San Francisco', date: '2026-06-17T22:00:00Z', canDraw: true, aiPrediction: 'AUT' },
  { matchNumber: 57, phase: 'group', group: 'J', team1: 'ARG', team2: 'AUT', venue: 'AT&T Stadium', city: 'Dallas', date: '2026-06-22T22:00:00Z', canDraw: true, aiPrediction: 'ARG' },
  { matchNumber: 58, phase: 'group', group: 'J', team1: 'JOR', team2: 'ALG', venue: "Levi's Stadium", city: 'San Francisco', date: '2026-06-23T22:00:00Z', canDraw: true, aiPrediction: 'ALG' },
  { matchNumber: 59, phase: 'group', group: 'J', team1: 'ARG', team2: 'JOR', venue: 'NRG Stadium', city: 'Houston', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'ARG' },
  { matchNumber: 60, phase: 'group', group: 'J', team1: 'ALG', team2: 'AUT', venue: 'AT&T Stadium', city: 'Dallas', date: '2026-06-26T22:00:00Z', canDraw: true, aiPrediction: 'AUT' },

  // ── GROUP K ──
  { matchNumber: 61, phase: 'group', group: 'K', team1: 'POR', team2: 'COD', venue: 'NRG Stadium', city: 'Houston', date: '2026-06-17T22:00:00Z', canDraw: true, aiPrediction: 'POR' },
  { matchNumber: 62, phase: 'group', group: 'K', team1: 'UZB', team2: 'COL', venue: 'Estadio Azteca', city: 'Mexico City', date: '2026-06-18T22:00:00Z', canDraw: true, aiPrediction: 'COL' },
  ...
  { matchNumber: 68, phase: 'group', group: 'L', team1: 'GHA', team2: 'PAN', venue: 'BMO Field', city: 'Toronto', date: '2026-06-18T22:00:00Z', canDraw: true, aiPrediction: 'GHA' },
  { matchNumber: 69, phase: 'group', group: 'L', team1: 'ENG', team2: 'GHA', venue: 'Gillette Stadium', city: 'Boston', date: '2026-06-23T22:00:00Z', canDraw: true, aiPrediction: 'ENG' },
  { matchNumber: 70, phase: 'group', group: 'L', team1: 'PAN', team2: 'CRO', venue: 'Gillette Stadium', city: 'Boston', date: '2026-06-24T22:00:00Z', canDraw: true, aiPrediction: 'CRO' },
  { matchNumber: 71, phase: 'group', group: 'L', team1: 'PAN', team2: 'ENG', venue: 'MetLife Stadium', city: 'New York/NJ', date: '2026-06-27T22:00:00Z', canDraw: true, aiPrediction: 'ENG' },
  { matchNumber: 72, phase: 'group', group: 'L', team1: 'CRO', team2: 'GHA', venue: 'Lincoln Financial Field', city: 'Philadelphia', date: '2026-06-27T22:00:00Z', canDraw: true, aiPrediction: 'CRO' },
];
